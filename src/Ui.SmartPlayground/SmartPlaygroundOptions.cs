...
public class SmartPlaygroundOptions
{
    ...
    /// </summary>
    public Func<SmartPlaygroundOptions, Stream> IndexStream { get; } = _ => typeof(SmartPlaygroundOptions).Assembly
        .GetManifestResourceStream("GraphQL.Server.Ui.SmartPlayground.Internal.smartplayground.chtml")!;

    /// <summary>
    /// Gets or sets a delegate that is called after all transformations of the GraphQL Playground UI page.
    /// </summary>
    public Func<SmartPlaygroundOptions, string, string> PostConfigure { get; set; } = (options, result) => result;
