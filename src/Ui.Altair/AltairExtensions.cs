...
namespace Microsoft.AspNetCore.Builder
{
    ...
    public static class PlaygroundExtensions
    {
        ...
        public static IApplicationBuilder UseAltairGraphQL(this IApplicationBuilder app, AltairGraphQLOptions options = null)
        {
            return app.UseMiddleware<AltairMiddleware>(options ?? new AltairGraphQLOptions());
        }
    }
}
